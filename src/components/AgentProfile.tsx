        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="md:flex">
            {agent.avatar ? (
              ...
              <div className="md:w-1/3 aspect-square md:aspect-auto bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
            ...
            <div className="md:w-2/3 p-8">
              ...
              {agent.position && (
                <p className="text-xl text-blue-600 mb-6">{agent.position}</p>
              )}

              {agent.bio && (
                <p className="text-gray-700 mb-8 leading-relaxed">{agent.bio}</p>
              )}
              ...
              <div className="space-y-4 mb-8">
                ...
                {agent.mobile && (
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`tel:${agent.mobile}`} className="text-gray-700 hover:text-blue-600">
                      {agent.mobile}
                    </a>
                  </div>
                )}
